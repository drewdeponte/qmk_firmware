...
#define _LOWER 2 // _LOWER
#define _MOTLR 3 // Motion Layer
 ...
 */
    [_RAISE] = LAYOUT(
        _______, _______, _______, _______, _______,                                      DV_EXLM,   DV_AT, DV_HASH,  DV_DLR, DV_PERC,
        _______, _______, _______, _______, _______,                                      DV_CIRC, DV_AMPR, DV_ASTR, DV_LPRN, DV_RPRN,
        _______, _______, _______, _______, _______,                                       DV_GRV, DV_SLSH, DV_BSLS, DV_QUES, DV_PIPE,
 ...
 */
    [_LOWER] = LAYOUT(
           DV_1,    DV_2,    DV_3,    DV_4,    DV_5,                                      _______, _______, _______, _______, _______,
           DV_6,    DV_7,    DV_8,    DV_9,    DV_0,                                      _______, _______, _______, _______, _______,
